					  ...
					  <table class="table table-striped">
						...
						<tbody>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat1')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat1')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat2')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat2')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat3')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat3')</td>
							</tr>
							<tr>
								<td>Izin Lokasi</td>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat4')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat4')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat5')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat5')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat6')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat6')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat7')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat7')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat8')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat8')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat9')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat9')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat10')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat10')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat11')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat11')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat12')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat12')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat13')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat13')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat14')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat14')</td>
							</tr>
							<tr>
								<td>Dokumen NIB</td>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat15')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat15')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat16')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat16')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat17')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat17')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat18')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat18')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat19')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat19')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pupr.part.detail_syarat20')</td>
								@endif
								<td>@include('pemohon.pupr.part.upload_syarat20')</td>
							</tr>
						</tbody>
					  </table>
					</div>
