	...
	<div class="col-md-12">
		...
		<div class="collapse" id="tambahIjinlingkungan">
			<div class="card card-body">
				...
				@include('pemohon.lingkungan.tambah_data_ijin')
				{{ Form::close() }}
			</div>
		</div>
		<div class="tile">
				...
				<table class="table table-bordered ijin_lingkungan">
					...
					<tbody>
						...
						<tr>
							...
							@include('pemohon.lingkungan.ubah_status')
							<td>
								{{ Form::model($dil, ['route'=>['pemohon.perijinan.deleteperijinan', $perijinan->slug_perijinan,$dil->id],'method'=>'POST']) }}
									@method('DELETE')
