					  ...
					  <table class="table table-striped">
						...
						<tbody>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pendidikan.part.detail_foto_direktur')</td>
								@endif
								<td>@include('pemohon.pendidikan.part.upload_foto_direktur')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pendidikan.part.detail_denah_lokasi')</td>
								@endif
								<td>@include('pemohon.pendidikan.part.upload_denah_lokasi')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pendidikan.part.detail_alamat_lokasi')</td>
								@endif
								<td>@include('pemohon.pendidikan.part.upload_alamat_lokasi')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('pemohon.pendidikan.part.detail_akta_sewa')</td>
								@endif
								<td>@include('pemohon.pendidikan.part.upload_akta_sewa')</td>
							</tr>
						</tbody>
					  </table>
					</div>
