...
<div class="row justify-content-md-center">
	<div class="col-md-8">
		...
		<div class="tile user-settings">
			...
			@if(is_null($user_pemohon))
			{{ Form::open(['route'=>'pemohon.home.dashboard.pemohon.post','method'=>'POST','id'=>'dasboard_data']) }}
				<div class="row mb-4">
					<div class="col-md-6">
						{{ Form::label('nik','NIK') }}
			...
			{{ Form::close() }}
			@else
			{{ Form::model($user_pemohon,['route'=>['pemohon.home.dashboard.pemohon.update',[$user_pemohon->id,auth()->user()->id]],'method'=>'POST','id'=>'dasboard_data']) }}
				@method('PATCH')
				<div class="row mb-4">
					<div class="col-md-6">
						{{ Form::label('nik','NIK') }}
						{{ Form::number('nik',$user_pemohon->nik,['class'=>'form-control','id'=>'nik','placeholder'=>'NIK']) }}
					</div>
					<div class="col-md-6">
						{{ Form::label('nama_lengkap','Nama Lengkap') }}
						{{ Form::text('nama_lengkap',$user_pemohon->nama_lengkap,['class'=>'form-control','id'=>'nama_lengkap','placeholder'=>'Nama Lengkap']) }}
					</div>
				</div>
				<div class="row mb-4">
					<div class="col-md-6">
						{{ Form::label('pekerjaan','Pekerjaan') }}
						{{ Form::text('pekerjaan',$user_pemohon->pekerjaan,['class'=>'form-control','id'=>'pekerjaan','placeholder'=>'Pekerjaan']) }}
					</div>
					<div class="col-md-6">
						{{ Form::label('jenis_kelamin','Jenis Kelamin') }}
						{{ Form::select('jenis_kelamin', ['L' => 'Laki-laki', 'P' => 'Perempuan'],$user_pemohon->jenis_kelamin, ['placeholder' => '-- Pilih Jenis Kelamin --','class'=>'form-control','id'=>'jenis_kelamin']) }}
					</div>
				</div>
				<div class="row mb-4">
					<div class="col-md-6">
						{{ Form::label('tempat_lahir','Tempat Lahir') }}
						{{ Form::text('tempat_lahir',$user_pemohon->tempat_lahir,['class'=>'form-control','id'=>'tempat_lahir','placeholder'=>'Tempat Lahir']) }}
					</div>
					<div class="col-md-6">
						{{ Form::label('tanggal_lahir','Tanggal Lahir') }}
						{{ Form::text('tanggal_lahir',$user_pemohon->tanggal_lahir,['class'=>'form-control','id'=>'tanggal_lahir','placeholder'=>'Tanggal Lahir']) }}
					</div>
				</div>
				<div class="row mb-4">
					<div class="col-md-6">
						{{ Form::label('rt','RT') }}
						{{ Form::number('rt',$user_pemohon->rt,['class'=>'form-control','placeholder'=>'RT']) }}
					</div>
					<div class="col-md-6">
						{{ Form::label('rw','RW') }}
						{{ Form::number('rw',$user_pemohon->rw,['class'=>'form-control','id'=>'rw','placeholder'=>'RW']) }}
					</div>
				</div>
				<div class="row mb-4">
					<div class="col-md-12">
						{{ Form::label('alamat','Alamat') }}
						{{ Form::textarea('alamat',$user_pemohon->alamat,['class'=>'form-control','id'=>'alamat','placeholder'=>'Alamat','rows'=>'2']) }}
					</div>
				</div>
				<div class="row mb-4">
					<div class="col-md-6">
						{{ Form::label('npwp','NPWP') }}
						{{ Form::number('npwp',$user_pemohon->npwp,['class'=>'form-control','id'=>'npwp','placeholder'=>'NPWP']) }}
					</div>
					<div class="col-md-6">
						{{ Form::label('no_telp','No.Telp') }}
						{{ Form::number('no_telp',$user_pemohon->no_telp,['class'=>'form-control','id'=>'no_telp','placeholder'=>'No.Telp']) }}
					</div>
				</div>
				<div class="row mb-10">
					<div class="col-md-12">
