	...
	<div class="col-md-12">
		...
		<div class="collapse" id="tambahIjinSiujk">
			<div class="card card-body">
				...
				@include('front_office.pupr.tambah_data_ijin')
				{{ Form::close() }}
			</div>
		</div>
		<div class="tile">
				...
				<table class="table table-bordered ijin_lingkungan">
					...
					<tbody>
						...
						<tr>
							...
							@include('front_office.pupr.ubah_status')
							<td>
								{{ Form::model($dis, ['route'=>['frontOffice.perijinan.deleteperijinan', $perijinan->slug_perijinan,$dis->id],'method'=>'POST']) }}
									@method('DELETE')
