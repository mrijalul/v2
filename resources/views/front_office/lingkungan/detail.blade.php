					  ...
					  <table class="table table-striped">
						...
						<tbody>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_imb')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_imb')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_s_pengantar_dlh')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_s_pengantar_dlh')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_d_pendirian_usaha')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_d_pendirian_usaha')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_izin_usaha')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_izin_usaha')</td>
							</tr>
							<tr>
								<td>Foto copy KTP</td>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_fc_ktp')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_fc_ktp')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_slf')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_slf')</td>
							</tr>
							<tr>
								<td>Dokumen NIB</td>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_d_nib')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_d_nib')</td>
							</tr>
							<tr>
								<td>Izin Lokasi</td>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_i_lokasi')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_i_lokasi')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_d_ukl')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_d_ukl')</td>
							</tr>
							<tr>
								<td>NPWP (Pribadi)</td>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_npwp_pribadi')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_npwp_pribadi')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_i_operasional')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_i_operasional')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_sk_dpmptsp')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_sk_dpmptsp')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_dp_usaha')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_dp_usaha')</td>
							</tr>
							<tr>
								...
								<td>-</td>
								@else
								<td>@include('front_office.lingkungan.part.detail_npwp_bhukum')</td>
								@endif
								<td>@include('front_office.lingkungan.part.upload_npwp_bhukum')</td>
							</tr>
						</tbody>
					  </table>
					</div>
