	...
	<div class="col-md-12">
		...
		<div class="collapse" id="tambahIjinPendidikan">
			<div class="card card-body">
				...
				@include('front_office.pendidikan.tambah_data_ijin')
				{{ Form::close() }}
			</div>
		</div>
		<div class="tile">
				...
				<table class="table table-bordered ijin_pendidikan">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="{{ route('frontOffice.perijinan.detail',[$perijinan->slug_perijinan,$dip->id]) }}" class="btn btn-block btn-primary"><i class="fa fa-info-circle" aria-hidden="true"></i></a>
							</td>
							@include('front_office.pendidikan.ubah_status')
							<td>
								{{ Form::model($dip, ['route'=>['frontOffice.perijinan.deleteperijinan', $perijinan->slug_perijinan,$dip->id],'method'=>'POST']) }}
									@method('DELETE')
